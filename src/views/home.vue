<template>
  <el-row class="container">
    <!--头部-->
    <el-col :span="24" class="topbar-wrap" v-show="isSubShow">
      ...
      <div class="topbar-title">
        <span style="font-size: 18px;color: #fff;">商城后台管理系统</span>
      </div>
    ...
    <!--中间-->
    <el-col :span="24" class="main" v-bind:style="{ top: topValue + 'px' }">
      <!--左侧导航-->
      <aside :class="{showSidebar:!collapsed}" v-show="isSubShow">
        <!--展开折叠开关-->
        ...
        <el-menu :default-active="defaultActiveIndex" router :collapse="collapsed" @select="handleSelect">
          <template v-for="(item,index) in $router.options.routes" v-if="item.menuShow">
            <el-submenu v-if="!item.leaf" :index="index+''">
              ...
              <el-menu-item v-for="term in item.children" :key="term.path" :index="term.path" v-show="term.menuShow" :class="$route.path==term.path?'is-active':''">
      ...
      <!--右侧内容区-->
      <section class="content-container" style="height: 100%;">
